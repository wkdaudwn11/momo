...
public class FreeBoardRepleDTO {
	...
	public FreeBoardRepleDTO(int reLevel, int ref, int step, int pfrnum, Integer frnum, int fnum, String id,
			String author, String content, String writeday) {
		super();
	...
	public String toString() {
		return "FreeBoardRepleDTO [reLevel=" + reLevel + ", ref=" + ref + ", step=" + step + ", pfrnum=" + pfrnum
				+ ", frnum=" + frnum + ", fnum=" + fnum + ", id=" + id + ", author=" + author + ", content=" + content
				+ ", writeday=" + writeday + "]";
	}
