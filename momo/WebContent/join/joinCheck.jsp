	...
	<script>
		...
		function changeRadio(agree){
			if(agree.value == 'agree'){
				...
				document.agreementForm.agree.checked=false;
			}
		}
	</script>
</head>
<body>
        ...
        <div class="container">
			<div class="row">
                <div class="col-md-12 text-center">
                	<br><span style="font-size:30px; font-weight:bold;">약관동의</span><br><br>            	
                    <textarea readonly="readonly" rows="25" cols="120" style="resize:none;">
	인터넷 쇼핑몰 『가정 가구 MOMO』회원 약관 
	제1조(목적)
	이 약관은 명품 가구 MOMO(전자상거래 사업자)가 운영하는 인터넷 쇼핑몰(이하 "몰"이라 한다)에서 제공
	하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 몰과 이용자의 권리·의
	...
	제2조(정의)
	①"몰" 이란 명품 가구 MOMO가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
	...
	번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 명품 가구 체리쉬 몰의 초기 서비스화면(전면)
